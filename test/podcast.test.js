...
const podcast = rewire('../lib/podcast')
Object.assign(podcast.config, {
  skillName: '',
  skillNameForSpeech: '',
  feedUrl: 'http://feed.example.com/podcast',
  tableName: 'dynamodb-test',
  podcastId: 'podcast-id',
  podcastName: 'podcast name',
  podcastNameForSpeech: 'ポッドキャスト',
  maxEpisodeCount: 10
})
...
describe('podcast module', () => {
  ...
  describe('saveToCache', () => {
    ...
    it('DynamoDB に episodes と headers がキャッシュされる', async () => {
      ...
      expect(mockDynamoDB._tableName).to.equal('dynamodb-test')
